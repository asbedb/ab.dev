...
function MainSidebar() {
    ...
    return (
        ...
        {/* Toggle Button */}
        <button
            className={isOpen ? `absolute top-4 left-60 -translate-x-full z-50 md:hidden 
                                bg-primary-600/50 text-secondary-50 p-3 
        ...
        <div
            ref={sidebarRef}
            className={`
            fixed top-0 left-0 h-full w-fit p-4 bg-primary text-secondary-100 
